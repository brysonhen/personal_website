...
// Sun rays shrink and rotate away. Center circle swells into the moon body.
// A mask carves the crescent. Spring physics throughout. Optional click sound.
...
export function AnimatedThemeToggler({ sound = true, className = '' }) {
  const rawId = useId()
